...
<main class="d-flex flex-nowrap">
    <ul class="nav nav-pills nav-flush flex-column mb-auto text-center" id="lista_selector">
      <li class="nav-item">
        <a id="li-consorcio" href="views/consorcio/consorcio.php" class="nav-link py-3 border-bottom rounded-0" aria-current="page" title="Consorcios" >
          <svg class="bi pe-none" width="24" height="24" role="img" aria-label="Consorcios"><use xlink:href="#home"/></svg>
        </a>
      </li>
      <li>
        <a id="li-extra" href="views/extra/extra.php"  class="nav-link py-3 border-bottom rounded-0" title="Extras" >
      ...
      <li>
        <a id="li-evento" href="views/evento/evento.php" class="nav-link py-3 border-bottom rounded-0" title="Eventos" >
          <svg class="bi pe-none" width="24" height="24" role="img" aria-label="Eventos"><use xlink:href="#table"/></svg>
        </a>
      </li>
      <li>
        <a id="li-ies" href="views/ies/ies.php" class="nav-link py-3 border-bottom rounded-0" title="IES" >
          <svg class="bi pe-none" width="24" height="24" role="img" aria-label="IES"><use xlink:href="#grid"/></svg>
        </a>
      </li>
      <li>
        <a id="li-contacto" href="views/contacto/contacto.php" class="nav-link py-3 border-bottom rounded-0" title="Contactos" >
